...
# 読み込むJSONファイルのパス
json_file_path = 'sentences-4dim/oneletters/changed_name/あ_20250924141205.json'

# 保存したいフォルダのパスを指定
output_folder = 'images/handwriting_raw'
